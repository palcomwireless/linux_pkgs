...
static gpointer msg_queue_thread_func(gpointer data) {
    ...
    while (1) {
        ...
        if (message.pwl_cid == PWL_CID_MADPT_RESTART) {
            ...
            if (strcmp(message.content, "4131001") == 0)
                device_package_ver = "DPV00.00.00.01";
            else if (strcmp(message.content, "4131002") == 0)
                device_package_ver = "DPV00.00.01.01";
            else if (strcmp(message.content, "4131003") == 0)
                device_package_ver = "DPV00.00.02.01";
            else if (strcmp(message.content, "4131004") == 0)
                device_package_ver = "DPV00.01.02.01";
            else if (strcmp(message.content, "4131005") == 0)
                device_package_ver = "DPV00.02.00.01";
            else
                device_package_ver = "DPV00.00.01.01";
